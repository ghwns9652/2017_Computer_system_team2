...
struct STAGE_REG Forward_Unit_EX_to_EX(STAGE_REG ID_EX, STAGE_REG EX_MEM, STAGE_REG MEM_WB)
{
	//EX_MEM to EX
...
struct STAGE_REG Forward_Unit_MEM_to_MEM(STAGE_REG EX_MEM, STAGE_REG MEM_WB)
{
